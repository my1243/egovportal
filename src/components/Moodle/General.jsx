    ...
    return (
        <>
            <div className="flex justify-center h-20">
                <h1 className="text-3xl font-bold mt-5">Sanjay Patel</h1>
            </div>
            <div className="px-5">
                <div className="bg-orange-200 mb-12 border-2 border-orange-500 max-w-[1296px] mx-auto rounded-md shadow-lg">
                    <form className="mx-4 my-8 ">
                        ...
                        <div className="mb-4 flex flex-col items-start sm:flex-row sm:items-center">
                            <label className="-mt-48 text-lg w-full sm:w-1/3 mb-0.5 sm:mb-0">
                                Discription
                            </label>
                            <input
                                className="h-60 p-2 w-full sm:w-2/3 rounded-lg placeholder-slate-900 border border-orange-500 outline-none focus:border-rose-300 transistion-all duration-33 ease-linear"
                                type={"email"}
                                name="Email"
                            />
                        </div>
