  ...
  return (
    <>
      <div className="relative flex items-center h-screen bg-orange-200 overflow-hidden">
        ...
        <div className="z-50 h-[80vh] max-w-[80vw] bg-white flex mx-auto rounded-lg ">
          <div className="w-1/2 h-full m-6 lg:m-12">
          ...
          <div className="w-1/2 flex items-center justify-center">
            <div className="z-40 h-4/5 bg-orange-200 rounded-xl shadow-2xl shadow-slate-300 p-4 w-96 mx-6">
              ...
              <button
                className="p-2 w-full text-center bg-[#e64b09] hover:bg-orange-400 text-white font-medium rounded-md transition-colors duration-300 ease-linear"
                onClick={re_home}
              >
