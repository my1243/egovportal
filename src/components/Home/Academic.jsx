...
const Academic = () => {
  return (
    <>
      <div>
        <h1 className="mx-2 lg:mx-8 md:mx-12 m-4 text-2xl lg:text-4xl font-bold pb-2">
        ...
        <div className="mx-12 mb-12">
          <table className="table_a rounded-lg overflow-hidden border border-orange-500 table-auto w-full h-96">
            ...
            <tbody>
              <tr className="bg-orange-100 px-3 py-2 text-center texl-lg">
                <td
                  data-label="Medium of exam"
                  className="text-center border border-white p-4"
                >
                  SSC
                </td>
                <td
                ...
                <td
                  data-label="Pass Year"
                  className="text-center border border-white"
                >
                  2018
                </td>
                <td
                  data-label="Pass Month"
                  className="text-center border border-white"
                >
                  March
                </td>
                ...
                <td
                  data-label="Institute Name"
                  className="text-center border border-white"
                >
                  M and m mehta high school
                </td>
                <td
                  data-label="Specialisation"
                  className="text-center border border-white"
                >
                  science
                </td>
                <td
                  data-label="Result Type"
                  className="text-center border border-white"
                >
                  percentile
                </td>
